...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        title_pie = f"Launche site: {site_dropdown}"
        intermediate = spacex_df[spacex_df['Launch Site'] == site_dropdown]
        filtered_df = intermediate.groupby(['Launch Site', 'class']).size().reset_index(name='class count')
